...
import { Car, Plus, Edit2, Trash2, X, Upload, Trash, Image as ImageIcon } from 'lucide-react'
...
export default function FleetClient({ initialVehicles }: { initialVehicles: any[] }) {
  ...
  const handleDelete = async (id: string) => {
    if (confirm('Are you sure you want to delete this vehicle? All its images will be deleted from storage.')) {
      setLoading(true)
      try {
